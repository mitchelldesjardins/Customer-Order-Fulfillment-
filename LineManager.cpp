...
namespace sict{
LineManager::LineManager(std::vector<Station*>& stationAddresses, std::vector<size_t>& indexNextStation, std::vector<CustomerOrder>& customerOrders, size_t indexStartingStation, std::ostream& os) : m_stationAddresses{stationAddresses} , m_indexStartingStation{ indexStartingStation }	{
